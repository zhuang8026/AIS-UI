  ...
  return vue_1.openBlock(), vue_1.createElementBlock("div", {
    ...
    return vue_1.openBlock(), vue_1.createElementBlock("tr", {
      ...
      return vue_1.openBlock(), vue_1.createElementBlock("td", {
        ...
        key: 0
      }, [vue_1.createElementVNode("p", _hoisted_11, vue_1.toDisplayString(detail.txt), 1), detail.hasOwnProperty('sub') ? (vue_1.openBlock(), vue_1.createElementBlock("p", _hoisted_12, vue_1.toDisplayString(detail.sub), 1)) : vue_1.createCommentVNode("", true)], 64)) : (vue_1.openBlock(), vue_1.createElementBlock("p", {
        key: 1,
        class: vue_1.normalizeClass(["txt style--status whitespace-normal break-words", detail.type.split(':')[1] == 1 ? 'normal' : 'active'])
      }, vue_1.toDisplayString(detail.txt), 3))], 64))], 10, _hoisted_10);
...
/*Fri Apr 28 2023 11:37:37 GMT+0800 (Taipei Standard Time)*/
