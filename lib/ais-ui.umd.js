...
function render(_ctx, _cache) {
  ...
  return vue_1.openBlock(), vue_1.createElementBlock("div", {
    ...
    return vue_1.openBlock(), vue_1.createElementBlock("tr", {
      ...
      class: vue_1.normalizeClass(["group odd:bg-grey-f4 even:bg-white [&>td]:active:bg-root-hoverBlue cursor-pointer", [_ctx.activeStyle(data.id), _ctx.highlightStyle(data)]])
