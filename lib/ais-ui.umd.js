...
const _hoisted_7 = {
  class: "check-content text-center align-middle"
};
...
function render(_ctx, _cache) {
  ...
  }), 256))])]), _ctx.privateDatas.length > 0 ? (vue_1.openBlock(), vue_1.createElementBlock("tbody", _hoisted_6, [(vue_1.openBlock(true), vue_1.createElementBlock(vue_1.Fragment, null, vue_1.renderList(_ctx.privateDatas, (data, index) => {
    return vue_1.openBlock(), vue_1.createElementBlock("tr", {
      key: 'datas-' + index + _ctx.updateKey,
      class: "odd:bg-grey-f4 even:bg-white"
    }, [vue_1.createElementVNode("td", _hoisted_7, [vue_1.createVNode(_component_UiCheckbox, {
      class: "ml-6px mr-6px",
      ...
      return vue_1.openBlock(), vue_1.createElementBlock("td", {
        class: vue_1.normalizeClass(["align-middle text-center", {
          'cursor-pointer': _ctx.isItemClick
        }]),
        key: 'detail-' + index,
        onClick: vue_1.withModifiers($event => _ctx.onClickItem(data), ["prevent"])
      }, [detail.type == 'default' ? (vue_1.openBlock(), vue_1.createElementBlock("p", _hoisted_9, vue_1.toDisplayString(detail.txt), 1)) : (vue_1.openBlock(), vue_1.createElementBlock("p", {
        key: 1,
        class: vue_1.normalizeClass(["txt style--status whitespace-normal break-words", detail.type.split(':')[1] == 1 ? 'normal' : 'active'])
      }, vue_1.toDisplayString(detail.txt), 3))], 10, _hoisted_8);
    }), 128))]);
  }), 128))])) : (vue_1.openBlock(), vue_1.createElementBlock("tbody", _hoisted_10, [vue_1.createElementVNode("tr", _hoisted_11, [vue_1.createElementVNode("td", {
    colspan: _ctx.isHasCheck ? _ctx.head.length + 1 : _ctx.head.length,
    class: "text-center color-ff whitespace-normal break-words"
  }, vue_1.toDisplayString(_ctx.emptyText), 9, _hoisted_12)])]))])]);
}
exports.render = render;
...
const _hoisted_5 = ["value", "id", "disabled"];
const _hoisted_6 = {
  class: "error h-21px flex items-center"
};
const _hoisted_7 = {
...
/*Thu Feb 16 2023 16:55:46 GMT+0800 (台北標準時間)*/
